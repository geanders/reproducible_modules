...
my_table <- tribble(
  ...
  "\\tabitem For each module video, how often has it been watched?", "Yes", "No", "Yes", "No",
  "\\tabitem When trainees watch a module's video, on average what percent do they watch?", "Yes", "No", "Yes", "No",
  "\\tabitem How often are additional educational materials (quizzes, applied exercise materials) used?", "Yes", "No", "Yes", "No",
  "\\tabitem How often is the entire book downloaded as a PDF or EPUB file?", "Yes", "No", "Yes", "No",
  "\\tabitem Which of the modules are used most frequently?", "Yes", "No", "Yes", "No",
  "\\tabitem What were the trainee's goals in using this training material?", "Yes", "No", "Yes", "No", 
  ...
  "\\tabitem Is so, how does the trainee plan to change research practices based on having taken the module?", "Yes", "No", "Yes", "No", 
  "\\tabitem Was the module useful enough that the trainee would recommend it to other scientists?", "Yes", "No", "Yes", "No",
  "\\tabitem Which elements of the training modules (video lecture, written text, additional educational materials) did the trainee find most useful?", "Yes", "No", "Yes", "No",
  "\\tabitem For each module video, are there spots where it is common for trainees to stop watching?", "Yes", "No", "Yes", "No",
  "\\tabitem Why did the trainee chose which modules to use?", "Yes", "No", "Yes", "No",
  "\\tabitem For the modules taken, what content did the trainee wish had been covered but was not?", "Yes", "No", "Yes", "No"
) %>% 
