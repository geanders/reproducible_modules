...
my_table <- tribble(
  ...
  "Principals and power of R's 'tidyverse'", "Principals",
    ...
    "\\tabitem Quiz: Questions will test the trainee's understanding of what R's 
      ...
      tools.",
  "Complex data types in R and Bioconductor", "Principals",
    ...
    "\\tabitem Applied exercise: We will provide example data in a complex, list-based format. 
      ...
      extract specified elements from the data format; 

      \\tabitem Video providing a detailed
      walk-through of completing this exercise, with explanations for specific steps.",
  "Converting from complex data types to 'tidy' data formats", "Implementation",
    ...
    "\\tabitem Describe what the broom and biobroom R packages can do; 
    ...
    "10", 
    "\\tabitem Quiz: Trainees will be tested on their understanding of 'tidy' versus complex
      data formats, the difficulties introduced by complex data formats, and how data 
      can be converted from a complex to a 'tidy' format in R; 

      \\tabitem Video discussing 
      correct answers to the quiz questions; 

      \\tabitem Links to tutorials to find out more
  ...
  "Example: Converting from complex data types to 'tidy' data formats", "Example",
    ...
    "\\tabitem Applied exercise: Trainees will be given an example dataset in a complex, 
      ...
      exercise.",  
  "How RMarkdown documents can improve data pre-processing", "Implementation",
    ...
    "15", 
    "\\tabitem Discussion questions: Including discussion of why RMarkdown (and similar
      approaches) could make data pre-processing more reproducible; 

      \\tabitem Short audio 
      recording of two Co-Is giving their
      own answers to these discussion questions.",
  "How to create reproducible data pre-processing protocols using RMarkdown", "Implementation",
    ...
    "\\tabitem Define a data pre-processing protocol; 
