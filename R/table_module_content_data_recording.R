...
text_tbl <- tribble(
  ...
  "Separating data recording and analysis", 
    "Many biomedical laboratories currently use spreadsheets, with embedded macros, 
      ...
      research.", 
    "(1) Explain the difference between data recording and data analysis; 
     (2) Understand why collecting data on spreadsheets with embedded macros
        impedes transparency and reproducibility; 
      (3) List alternative approaches that separate data recording and data analysis to 
        improve transparency and reproducibility.", 
    "15", 
    "(1) Discussion questions, including describing data recording approaches the trainee has 
      ...
      reproducibility; (2) Short audio recording of two Co-Is giving their
      own answers to these discussion questions.",
  "Principals and power of the 'tidy' data format", 
    ...
    "(1) List the characteristics that make a dataset 'tidy'; 
      ...
      (3) Outline other benefits of using a 'tidy' format when recording data.", 
    "25", 
    "(1) Quiz questions: For example datasets, correctly identify which of the 'tidy'
  ...
  "Designing templates for tidy data collection", 
    ...
    "(1) Identify characteristics that keep a dataset from following a 'tidy' format;
      (2) Convert data from an 'untidy' to a 'tidy' format.", 
    "20", 
    "(1) Applied exercise: Take a dataset in an 'untidy' format, identify what 
  ...
  "Example: Creating a template for data collection", 
    "In this module, we will walk through an example of creating a template to collect
      ...
      'tidy' format.", 
    "(1) Understand how the principals of 'tidy' data can be applied to experimental
      data from a real research project;
      (2) Explain the advantages of using a 'tidy' data format for the example project.", 
    "15", 
    "(1) Discussion questions, including listing examples of how experimental datasets
      ...
      own answers to these discussion questions.", 
  "Power of using a single 'Project' directory for storing and tracking research project files", 
    ...
    "(1) Describe a 'Project' directory, including common components and subdirectories; 
    ...
    "20", 
    "(1) Quiz questions: These will test the trainee's understanding of what a 
  ...
  "Creating 'Project' templates", 
    ...
    "(1) Explain how using a consistent structure for research 'Project' directories
    ...
    "25", 
    "(1) Discussion questions, including descriptions of how the trainee has saved and
  ...
  "Example: Creating a 'Project' template", 
    ...
    "(1) Create a 'Project' template in RStudio to use to initialize 
      consistently-formatted 'Project' directories to store all files related to 
      a research project; (2) Initialize a new 'Project' directory using this template.", 
    "15", 
    "(1) Applied exercise: We will provide a description of the components and 
  ...
  "Harnessing version control for transparent data collection", 
    ...
    "(1) Describe version control and what it does; (2) List how using version 
      control improves the transparency and reproducibility of research.", 
    "10", 
    "(1) Discussion questions, including discussion of how the trainee has 
      ...
      own answers to these discussion questions.",
  "Using git and GitLab to enhance the reproducibility of collaborative research", 
    ...
    "(1) Explain the benefits of using a version control platform like GitLab, rather 
      ...
      (4) Understand how to connect with GitLab through RStudio and how to use these
        ...
        research projects.", 
    "20", 
    "(1) Applied exercise, with detailed instructions for each step: Use RStudio to 
...
my_table <- kable(text_tbl, "latex", booktabs = TRUE, longtable = TRUE,
                  caption = "Modules for 'Improving the Reproducibility of Experimental Data Recording'") %>% 
