...
# Module 4
  "Designing templates for tidy data collection", "Implementation",
    ...
    "20", 
    "\\tabitem Applied exercise: For an 'untidy' dataset, identify what 
...
# Module 5
  "Example: Creating a template for 'tidy' data collection", "Example",
    ...
    "\\tabitem Understand how the principles of 'tidy' data can be applied 
      ...
      \\tabitem List some advantages of using a 'tidy' data format for the example project", 
    "15", 
...
# Module 6
  "Power of using a single structured 'Project' directory for storing and tracking research project files", "Principles",
    ...
    "20", 
    "\\tabitem Quiz questions: Test the trainee's understanding of a structured
...
# Module 8
  "Example: Creating a 'Project' template", "Example",
    "In this module, we will walk through a real example, based on the experiences of
...
# Module 9
  "Harnessing version control for transparent data recording", "Principles",
    "As a research project progresses, a typical practice in many experimental 
      ...
      and reproducibility of research, particularly for transparent data recording.", 
    "\\tabitem Describe version control and what it does 
      ...
      the data recording stage of research", 
    "10", 
...
# Module 10
  "Enhance the reproducibility of collaborative research with version control platforms", "Principles",
    ...
    "\\tabitem List the benefits of using a version control platform like GitLab, rather 
