...
\textbf{Trainees who access and use the online book and embedded materials.}  We will plan to develop and post the text and some of the additional educational materials (e.g., quizzes, discussion questions) online through \textit{GitHub} \textit{as we write the book and develop the materials}. We will use social media to invite people to try out the book as we develop it. Based on previous work developing online books, we have found that this open development process can help attract users very early in the process, and that these users are often very helpful in providing feedback as the book is developed. We will elicit their feedback through \textit{GitHub} (``Issues" page will be the main forum for them to post comments and suggestions). [These could potentially be from anywhere in the world, and for many we won't have great ways to contact them.]
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/timeline.pdf}
