...
transform, and reformat various elements of the data shared with them by laboratory bench researchers following any such stages of data recording and pre-processing, and that data is often shared in an unstructured format, increasing the risks of introducing errors through reformatting the data through ``data cleaning'' in order to apply more advanced computational methods
...
% Such spreadsheets include various 
...
% functions that are combined with the primary or raw experimental data.  

% these spreadsheets in an often labor intensive and error 
...
ecosystem for reproducible research to \underline{laboratory bench scientists} whose attention is rather to 
...
audience of laboratory bench biomedical researchers in need of training materials to improve the reproducibility of data
...
another way for our key audience of laboratory bench biomedical researchers to find and access the materials.
...
laboratory bench research to improve understanding of tuberculosis and other
...
transparency in the laboratory bench biomedical research projects of Drs.
...
Further, improving the computational reproducibility of the steps of data recording and pre-processing has other key advantages for laboratory bench researchers, including making collaborations with
statisticians 
...
reproducibility of data recording and pre-processing in laboratory bench
...
laboratory bench researchers how to use these tools}. 

Through this project, we aim to create training modules that will teach laboratory bench biomedical
...
in the hands of laboratory bench, rather than computationally-based, researchers.
...
pre-processing} for \textbf{laboratory bench researchers}. 
...
efficiency of laboratory bench biomedical research projects. These problems have also been 
...
biomedical laboratory bench research programs, including those here at Colorado
State University. Training materials that are short, 
modular, and accessible can help fill a critical need in providing laboratory bench biomedical researchers this needed
...
training modules that address the needs of laboratory bench biomedical
...
fill an important training gap for laboratory bench biomedical researchers
...
\textit{RStudio} interface. \textit{Examples} modules will provide materials that can be used as a template for implementing R-based tools, but can also provide a top-level overview for non-programmers of how these tools can improve real biomedical research projects. By co-authoring the modules with the biomedical laboratory bench co-investigators
...
To improve reproducibility practices among our target audience of laboratory bench biomedical researchers, it is important
...
collaborations between laboratory bench scientists and statisticians throughout
...
We appreciate that many laboratory bench biomedical researchers do not know the R language, and
...
laboratory bench biomedical researchers in microbiology and immunology
...
collection and pre-processing among laboratory bench biomedical researchers}.
...
Colorado State University is host to a large number of laboratory bench
...
laboratory bench biomedical researchers. We have received statements of support
...
laboratory bench biomedical researchers. We will recruit trainees with a variety
