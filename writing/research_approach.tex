...
Further, improving the reproducibility of these steps will make collaborations with
statisticians 
...
Many of the principles and tools for improving reproducibility at the steps 
of data recording and pre-processing are new and developing, and so many 
biomedical researchers did not have the opportunity to learn them at previous 
...
modular, and accessible can help fill a critical need in providing this needed
training \cite{munafo2017manifesto} and have proven very popular in providing 
similar training to the audience of data scientists and statisticians \cite{leek2015opinion}. To reach a key audience of laboratory-based scientists, these training materials
must be appropriate to trainees with a variety of prerequisite programming skills, 
including material that can provide a useful coverage of the principles
for trainees with little or no programming experience. Further, this material must
include viewpoints from researchers in our key audience of laboratory-based researchers,
and they must include examples of implementing the techniques that will be relevant to
this audience.
