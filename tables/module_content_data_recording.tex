...
\textcolor{blue}{\textbf{Principals and power of structured data formats}} & The format in which experimental data is recorded can have a large influence
...
\textcolor{black}{\textbf{Example: Creating a template for 'tidy' data collection}} & In this module, we will walk through an example of creating a template to collect
      ...
      'tidy' format. & \tabitem Understand how the principals of 'tidy' data can be applied 
