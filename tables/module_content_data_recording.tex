...
\begin{longtable}[t]{>{\bfseries\raggedright\arraybackslash\leavevmode\color{blue}}p{10em}>{\raggedright\arraybackslash}p{24em}>{\raggedright\arraybackslash}p{15em}>{\raggedright\arraybackslash}p{3em}>{\raggedright\arraybackslash}p{15em}}
\caption{\label{tab:}Modules for 'Improving the Reproducibility of Experimental Data Recording'}\\
\hiderowcolors
\toprule
...
\midrule
\endfirsthead
\caption[]{Modules for 'Improving the Reproducibility of Experimental Data Recording' \textit{(continued)}}\\
\toprule
Module title & Description of module content & Objectives (After taking the module, the trainee can ...) & Video Length & Extra educational materials\\
\midrule
\endhead
...
\endlastfoot
\showrowcolors
Separating data recording and analysis & Many biomedical laboratories currently use spreadsheets, with embedded macros, 
      ...
      research. & (1) Explain the difference between data recording and data analysis; 
     (2) Understand why collecting data on spreadsheets with embedded macros
      ...
      (3) List alternative approaches that separate data recording and data analysis to 
        improve transparency and reproducibility. & 15 & (1) Discussion questions, including describing data recording approaches the trainee has 
