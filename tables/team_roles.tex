...
\caption{\label{tab:}\label{tab:roles} Roles of our team of investigators in developing the proposed training materials.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{>{\centering\arraybackslash}p{25em}ccccc}
\toprule
