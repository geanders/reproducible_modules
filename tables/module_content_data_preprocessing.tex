...
\textcolor{blue}{\textbf{Principals and power of R's 'tidyverse'}} & The R programming language now includes a collection of 'tidyverse' extension 
      ...
      tools.\\
\textcolor{blue}{\textbf{Complex data types in R and Bioconductor}} & Raw data from many biomedical experiments, especially those that
      ...
      explore and extract data stored in R in this format. & \tabitem Explain why R software for pre-processing biomedical data often stores the 
      ...
      and extract data stored in R's complex, list-based structures. & 15 & \tabitem Applied exercise: We will provide example data in a complex, list-based format. 
...
\textcolor{red}{\textbf{Converting from complex data types to 'tidy' data formats}} & With the rising popularity of the 'tidyverse' collection of R tools, which require
      ...
      general 'tidyverse' tools. & \tabitem Describe what the broom and biobroom R packages can do; 

      \tabitem Explain why 
      converting data from a complex format to a 'tidy' format can improve the 
      transparency and reproducibility of a research project. & 10 & \tabitem Quiz: Trainees will be tested on their understanding of 'tidy' versus complex
...
\textcolor{black}{\textbf{Example: Converting from complex data types to 'tidy' data formats}} & We will provide a detailed example of a case where data pre-processing in R
      ...
      exercise.\\
\textcolor{red}{\textbf{How RMarkdown documents can improve data pre-processing}} & RMarkdown can be used to create documents that combine code and text in a 
      ...
      of the pre-processing of experimental data. & \tabitem Define RMarkdown; 
      ...
      of research projects at the data pre-processing phase. & 15 & \tabitem Discussion questions: Including discussion of why RMarkdown (and similar
      approaches) could make data pre-processing more reproducible; 

      \tabitem Short audio 
      recording of two Co-Is giving their
      own answers to these discussion questions.\\
\textcolor{red}{\textbf{How to create reproducible data pre-processing protocols using RMarkdown}} & In this module, we will provide detailed instructions on how to use RMarkdown
      ...
      pre-processing steps to different sets of raw data. & \tabitem Define a data pre-processing protocol; 
