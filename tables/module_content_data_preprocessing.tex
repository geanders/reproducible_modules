...
\caption{\label{tab:}Modules for 'Improving the Reproducibility of Experimental Data Pre-Processing'}\\
\hiderowcolors
\toprule
...
\midrule
\endfirsthead
\caption[]{Modules for 'Improving the Reproducibility of Experimental Data Pre-Processing' \textit{(continued)}}\\
\toprule
Module title & Description of module content & Objectives (After taking the module, the trainee can ...) & Video Length & Extra educational materials\\
\midrule
\endhead
...
\endlastfoot
\showrowcolors
Principals and benefits of scripted pre-processing of experimental data & The experimental data collected for biomedical research often requires 
      ...
      transparency of research. & (1) Define pre-processing of experimental data and give some examples; 
      ...
      pre-process biomedical experimental data. & 15 & (1) Discussion questions, including discussion of which steps are commonly used to 
