...
\midrule
Process & To what extent is the program implemented as proposed? [F \& S] & \tabitem Project team surveys to determine the extent to which the program activities are 
...
Product & How well does implementation of the training modules meet the 
  program objectives? [F \& S] & \tabitem Survey data collected to understand whether and how well the training modules 
